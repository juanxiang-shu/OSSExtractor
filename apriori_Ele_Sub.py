...
class AprioriEleSub:
    def __init__(self):
        ...
        for file_path in data_files:
            with open(file_path, "r", encoding="utf-8") as file:
                ...
                combined_set = set(element) | set(substrate)
    ...
    def generate_heatmap(self):
        ...
        for itemset in matrix_1:
            ele = list(itemset)
            if (ele[0].endswith('(111)') or ele[0].endswith('(110)')) and (
                    ele[1].endswith('(111)') or ele[1].endswith('(110)')):
                continue
        ...
        #     nx.draw_networkx_edge_labels(directed_graph, pos, edge_labels=edge_labels, ax=ax, font_size=10)
        #
        #     ax.set_title("Element VS Substrate")
        #
        # plt.tight_layout()
        return plt.gcf()