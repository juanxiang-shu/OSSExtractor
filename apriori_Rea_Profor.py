...
class AprioriReaProFor:
    def __init__(self):
        ...
        for file_path in data_files:
            with open(file_path, "r", encoding="utf-8") as file:
                ...
                combined_set = set(reactions) | set(product_form)
    ...
    def generate_heatmap1(self):
        ...
        for itemset2 in itemset_elements:
            ele = list(itemset2)
            if ele[0] in Product_form and (ele[1] in reaction_words):
                continue
            else:
    ...
    def generate_heatmap2(self):
        ...
        for itemset2 in itemset_elements:
            ele = list(itemset2)
            if ele[1] in Product_form and ele[0] in reaction_words:
                continue
            else:
                itemset_elements1.append(ele)
