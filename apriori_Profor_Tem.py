...
class AprioriProForTem:
    def __init__(self):
        ...
        for file_path in data_files:
            with open(file_path, "r", encoding="utf-8") as file:
                ...
                combined_set = set(product_form) | set(temperature)
    ...
    def generate_heatmap1(self):
        ...
        for itemset in matrix_1:
            ...
            if ele[0] in Product_form and ele[1] in Product_form:
                continue
            if ele[0].endswith('3k') and ele[1].endswith('3k'):
                continue
            if ele[0].endswith('K') and ele[1].endswith('K'):
                continue
            if ele[0].endswith('C') and ele[1].endswith('C'):
                continue
            else:
        ...
        for itemset2 in itemset_elements:
            ele = list(itemset2)
            if ele[0] in Product_form and ele[1].endswith('K'):
                continue
            if ele[0] in Product_form and ele[1].endswith('3k'):
                continue
            if ele[0] in Product_form and ele[1].endswith('K'):
                continue
            else:
    ...
    def generate_heatmap2(self):
        ...
        for itemset2 in itemset_elements:
            ele = list(itemset2)
            if ele[1] in Product_form and ele[0].endswith('K'):
                continue
            if ele[1] in Product_form and ele[0].endswith('K'):
                continue
            if ele[1] in Product_form and ele[0].endswith('3k'):
                continue
            else:
