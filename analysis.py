...
from apriori_Ele_Tem import AprioriEleTem
from apriori_Ele_Rea import AprioriEleRea
from apriori_Ele_ProFor import AprioriEleProFor
from apriori_Ele_Sub import AprioriEleSub
from apriori_Rea_Profor import AprioriReaProFor
from apriori_Rea_Tem import AprioriReaTem
from apriori_Rea_Sub import AprioriReaSub
from apriori_Profor_Sub import AprioriProForSub
from apriori_Profor_Tem import AprioriProForTem
...
class Analysis(QWidget):
    def __init__(self, text_edit, stacked_widget):
        ...
        # self.element_checkbox = QCheckBox("Element")
        # self.element_checkbox.setStyleSheet("QCheckBox {background-color: #3E6b83;"
        #                                     " color: white; border: 2px solid #F4F1EA;"
        #                                     " font-family: Arial; border-radius: 18px; padding: 10px 20px;"
        #                                     "font-size: 18px; font-weight: bold;}"
        #                                     "QCheckBox:hover {background-color: #AFACB7;}")
        # layout.addWidget(self.element_checkbox)
    ...
    def extract_and_process_data(self):
        ...
        # element_checked = self.element_checkbox.isChecked()
        ...
        selected_count = sum([reactions_checked, substrate_checked, temperature_checked,
                              ])#precursors_checked,, products_checked,element_checked, product_form_checked
        if selected_count > 2:
            self.show_selection_error_dialog("Only two options can be selected!")
            return

        # if temperature_checked and element_checked:
        #     apriori_eletem = AprioriEleTem()
        #     heatmap_figure = apriori_eletem.generate_heatmap()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.exec_()

        # if reactions_checked and element_checked:
        #     apriori_elerea = AprioriEleRea()
        #     heatmap_figure = apriori_elerea.generate_heatmap()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.exec_()

        # if product_form_checked and element_checked:
        #     apriori_eleprofor = AprioriEleProFor()
        #     heatmap_figure = apriori_eleprofor.generate_heatmap()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.exec_()
        #
        # if substrate_checked and element_checked:
        #     apriori_elesub = AprioriEleSub()
        #     heatmap_figure = apriori_elesub.generate_heatmap()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.exec_()
        #
        # if product_form_checked and reactions_checked:
        #     apriori_reaprofor = AprioriReaProFor()
        #     heatmap_figure = apriori_reaprofor.generate_heatmap1()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.show()
        #
        #     heatmap_figure = apriori_reaprofor.generate_heatmap2()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.show()
        ...
        # if product_form_checked and temperature_checked:
        #     apriori_profortem = AprioriProForTem()
        #     heatmap_figure = apriori_profortem.generate_heatmap1()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.show()
        #
        #     heatmap_figure = apriori_profortem.generate_heatmap2()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.show()
        #
        # if product_form_checked and substrate_checked:
        #     apriori_proforsub = AprioriProForSub()
        #     heatmap_figure = apriori_proforsub.generate_heatmap1()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.show()
        #
        #     heatmap_figure = apriori_proforsub.generate_heatmap2()
        #
        #     chart_dialog = ChartDialogA(self)
        #     chart_dialog.set_figure(heatmap_figure)
        #     chart_dialog.show()
